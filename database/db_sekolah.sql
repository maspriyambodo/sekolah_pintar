...
CREATE TABLE `mst_soal` (
  ...
  `tipe` tinyint NOT NULL COMMENT 'Referensi ke sys_references dengan kategori tipe_soal (1: Pilihan Ganda, 2: Essay)',
  `tingkat_kesulitan` tinyint NOT NULL COMMENT 'Referensi ke sys_references dengan kategori tingkat_kesulitan',
...
CREATE TABLE `trx_presensi` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT 'Referensi ke sys_references dengan kategori status_presensi',
