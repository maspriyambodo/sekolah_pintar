...
CREATE TABLE `trx_pembayaran_spp` (
  ...
  `status` enum('lunas','belum_lunas','pending','dibatalkan') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'pending',
  `metode_pembayaran` enum('tunai','transfer','virtual_account','qris') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'tunai',
  `keterangan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
